...
import {
  shopifyCustomerToUnified,
  shopifyOrderToUnified,
} from '@/lib/normalization/adapters/shopify.adapter'
import {
  salesforceContactToUnified,
  salesforceOpportunityToUnified,
} from '@/lib/normalization/adapters/salesforce.adapter'
...
describe('shopify adapter', () => {
  it('normalizes a customer, joining first/last name', () => {
    const c = shopifyCustomerToUnified({
      id: '1',
      email: 'e@e.com',
      first_name: 'Emma',
      last_name: 'Watson',
...
describe('salesforce adapter', () => {
  it('normalizes a contact', () => {
    const c = salesforceContactToUnified({
      Id: 'sf1',
      Email: 'n@acme.com',
      Name: 'Noah',
      AccountId: 'acc1',
...
describe('csv adapter', () => {
  it('passes through amount as-is (already integer cents) and lowercases currency', () => {
    const t = csvRowToUnifiedTransaction({
      id: 'row1',
      email: 'x@x.com',
      amount: 5000,
      currency: 'EUR',
